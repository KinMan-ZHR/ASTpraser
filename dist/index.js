...
import { LanguageType, Severity } from './common/types.js';
...
class CodeChecker {
        ...
        try {
            ...
            if (['.js', '.jsx', '.ts', '.tsx', '.vue'].includes(ext)) {
                ...
                if (ext === '.js')
                    ...
                    languageType = LanguageType.REACT;
                else if (ext === '.vue')
                ...
                // Java代码文件
                const options = { languageType: LanguageType.JAVA };
                // 使用简易Java解析器
     ...
     * 检测目录下的所有文件
     */
    async checkDirectory(dirPath, extensions = ['.js', '.jsx', '.ts', '.tsx', '.vue', '.java']) {
