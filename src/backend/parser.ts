...
export class JavaParser {
   ...
   * 解析Java文件为AST
   */
  static async parseFile(filePath: string, options: ParserOptions): Promise<any> {
    try {
   ...
   * 解析Java代码内容为AST
   */
  static async parseContent(content: string, filePath: string, options: ParserOptions): Promise<any> {
